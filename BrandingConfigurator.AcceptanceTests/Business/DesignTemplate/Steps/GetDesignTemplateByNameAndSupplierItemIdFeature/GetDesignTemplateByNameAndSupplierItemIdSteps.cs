...
public class GetDesignTemplateByNameAndSupplierItemIdSteps
{
    ...
    public GetDesignTemplateByNameAndSupplierItemIdSteps(
    ...
    public void GetDesignTemplateByNameAndSupplierItemId()
    {
        _designTemplate = _designTemplateService.GetDesignTemplateByNameAndSupplierItemId(_name, SupplierItemId, _userId);
    }

    public void GetDesignTemplateByNameAndWithoutSupplierItemId()
    {
        try
        {
            _designTemplate = _designTemplateService.GetDesignTemplateByNameAndSupplierItemId(_name, "", _userId);
        }
        catch (Exception ex)
        {
            _responseException = ex;
    ...
    public void GetDesignTemplateWithoutNameAndWithSupplierItemIdForUserId()
    {
        try
        {
            _designTemplate = _designTemplateService.GetDesignTemplateByNameAndSupplierItemId("", SupplierItemId, _userId);
        }
        catch (Exception ex)
        {
            _responseException = ex;
    ...
    public void GetDesignTemplateByNameAndSupplierItemIdLocale(string locale)
    {
        _designTemplate = _designTemplateService.GetDesignTemplateByNameAndSupplierItemId(_name, SupplierItemId, _userId, locale);
    }
